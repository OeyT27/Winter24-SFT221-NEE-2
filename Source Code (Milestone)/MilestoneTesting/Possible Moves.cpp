...
namespace Moves
{
    ...
    public:
        ...
        //Whitebox testing
        // 
        // Test when there are no possible moves
        TEST_METHOD(TestGetPossibleMoves6)
        {
            Map map = populateMap();
            Point p1 = { 0, 0 };
            Point backpath = { 0, 1 };
            ...
            //Assert
            Assert::AreEqual(0, possibleMoves.numPoints);
        }

        // Test when there is only one possible move
        TEST_METHOD(TestGetPossibleMoves7)
        {
            Map map = populateMap();
            Point p2 = { 5, 5 };
            Point backpath = { 6, 5 };
        ...
        // Test when the point is at the edge of the map
        TEST_METHOD(TestGetPossibleMoves8)
        {
            Map map = populateMap();
            Point p3 = { 0, 0 };
            Point backpath = { 1, 0 };
